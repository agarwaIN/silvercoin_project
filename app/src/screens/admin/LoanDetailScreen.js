...
const styles = StyleSheet.create({
  ...
  rejectBtn: { flex: 1, minWidth: 140, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#FEF2F2', paddingVertical: 14, borderRadius: 12, borderWidth: 1, borderColor: colors.error },
  rejectBtnText: { fontFamily: fonts.semiBold, fontSize: fontSize.base, color: colors.error, textAlign: 'center' },
  approveBtn: { flex: 1, minWidth: 140, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: colors.success, paddingVertical: 14, borderRadius: 12 },
  approveBtnText: { fontFamily: fonts.semiBold, fontSize: fontSize.base, color: colors.white, textAlign: 'center' },
